...
export default function ThankYouPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8f8f6]">
      ...
      <main
        ref={contentRef}
        className="lg:max-w-[726px] mx-auto flex-1 flex flex-col items-center justify-center pt-30"
      >
        <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-3xl mb-8">
          ...
          >
            <h2
              ref={titleRef}
              className="text-[32px] px-6 font-normal font-metrophobic tracking-[1px] pt-4 pb-6 text-black mb-2"
            >
            ...
            >
              ...
              />
              <div>
                <p className="font-normal font-avenir text-left text-black text-[18px]">
                  Black Crew Tee | Him
                </p>
                <p className="font-normal font-avenir text-left text-black text-[14px] pt-2">
                  ₹ 1999
                </p>
              </div>
            </div>
            ...
            <p
              ref={descriptionRef}
              className="font-normal font-metrophobic text-black text-[18px] mt-2 pt-8 p-4"
            >
              We will be in touch with you shortly.
              <br />
              Our fit consultant will call you and explain to you about our fit
              and then we will ship the product within 2 working days.
            </p>
          </div>
        </div>
        <Footer />
