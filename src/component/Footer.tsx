    ...
    return (
        <div className={`${className} flex flex-wrap justify-between items-center px-0 py-14 w-full`}>
            ...
            <div className="flex flex-col items-center w-full md:w-auto px-6">
                <p className="text-black/64 text-[16px] font-medium font-avenir text-center my-6">
                ...
                <div className="flex items-center gap-8 mb-4 px-6">
                    ...
                    <Link href="/about" className="text-black/64 text-[16px] font-medium font-avenir hover:underline">
                        About Us
                    </Link>
                    <Link href="/help" className="text-black/64 text-[16px] font-medium font-avenir hover:underline">
                        Help
                    </Link>
                </div>

                {/* Copyright */}
                <p className="text-black/64 text-[14px] font-medium font-avenir text-center">
